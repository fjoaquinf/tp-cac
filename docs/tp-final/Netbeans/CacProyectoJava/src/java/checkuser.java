...
public class checkuser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            Persistencia base = new Persistencia(); // Genero una instancia de persistencia
            ...
            if (rs.first()==false){
                out.println("No hay resultados para esta búsqueda");
                out.println("<h1>Proyecto " + request.getContextPath() + "</h1>"); // Qué servidor estoy usando
